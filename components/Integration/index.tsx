      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `Erfolgreich`,
              subtitle: `Erfolgreich auf allen Fronten`,
              description: `Unsere Arbeit erstreckt sich über vielfältige soziale Medien. Wir konzipieren individuelle Strategien, um Ihre Marke auf diesen Plattformen hervorzuheben und das Interesse Ihrer Zielgruppe zu wecken. `,
            }}
          />
