        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="flex lg:items-center lg:gap-8 xl:gap-32.5">
            <div className=" md:w-1/2">
              ...
              <p>
                Unser Können liegt darin, für dich die perfekte Social-Media-Strategie zu weben. Wie ein Maßanzug, aber für deine Online-Präsenz. Wir setzen auf maßgeschneiderte Lösungen, die wie ein Handschuh zu deinem Unternehmen passen. Deine Marke ist einzigartig – und genau das spiegelt sich in unserer individuellen Herangehensweise wider.
              </p>
