      ...
      <section className="pt-18.5 pb-20 lg:pb-22.5 relative">
        <SectionHeader
          headerInfo={{
            ...
            subtitle: "Wie eine Zusammenarbeit mit uns aussieht: ",
            description: `Ihre Marke erstrahlt auf Social Media. Gezielte Inhalte, Reichweitensteigerung und klare Kommunikation bringen Ihre Präsenz auf das nächste Level.`,
          }}
        />
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0 mt-8 relative">
