        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap lg:justify-between gap-8 lg:gap-0">
              ...
              >
                ...
                <h1 className="text-lg">Glow Mind</h1>
                <p className="mt-5 mb-10">
                  Abschluss und Kontaktaufnahme Ihre Aufmerksamkeit für unsere Inhalte freut uns sehr. Nun ist der richtige Zeitpunkt gekommen, um uns persönlich kennenzulernen und über Ihre Projektvorstellungen zu sprechen. Wir laden Sie herzlich dazu ein, das Kontaktformular auszufüllen, um einen unverbindlichen Gesprächstermin zu vereinbaren.
                </p>
          ...
          <div className="border-t border-stroke dark:border-strokedark flex flex-wrap flex-col lg:flex-row items-center justify-center lg:justify-between gap-5 lg:gap-0 py-7">
            ...
            <motion.div
              ...
              className="animate_top"
            >
              <p>&copy; {currentYear} Glow Mind. All rights reserved</p>
            </motion.div>
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <a href="https://instagram.com/glowmindmedia" target="_blank">
                    <svg
