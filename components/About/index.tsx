        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <p>
                Wir sind nicht bloß eine Social Media Marketing Agentur, sondern ein exquisites und leidenschaftliches Team, das aus drei erfahrenden Fachleuten besteht.
              </p>

              <br />

              <p>
                Unser vorrangiges Ziel ist es, dein Geschäft im digitalen Raum zum Erblühen zu bringen und eine unvergesslich ansprechende Online-Erfahrung für deine Kunden zu kreieren.
              </p>

              <br />

              <p>
                Durch tiefgreifendes Branchenwissen und ein profundes Verständnis für die Bedürfnisse deiner Zielgruppen entwickeln wir maßgeschneiderte Lösungen, um deine individuellen Ziele in vollendeter Form umzusetzen.
              </p>
        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 2xl:px-0 overflow-hidden">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              ...
              <p>
                begleitet von Transparenz, Offenheit und einer harmonischen Zusammenarbeit. Mit aufmerksamem Gehör und kreativen Diskussionen bringen wir deine visionären Ideen zur Realität und schmieden gemeinsam ausgefeilte Strategien.
              </p>

              <br />
              
              <p>
                Unsere Partnerschaft übersteigt den Rahmen eines gewöhnlichen Dienstleistungsverhältnisses und entwickelt sich zu einer inspirierenden Symbiose. (Dienstleistungen): Was du in einer Zusammenarbeit mit uns erwarten kannst
              </p>
              <div>
                <a
                  href="#"
